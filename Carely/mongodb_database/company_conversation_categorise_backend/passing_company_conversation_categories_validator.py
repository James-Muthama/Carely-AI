...
collection_name = "Company_Conversations_Categories"  # This matches the code: self.conversations_collection = self.db.CompanyConversations
...
try:
    ...
    if collection_name in db.list_collection_names():
        ...
        result = db.command("collMod", collection_name, validator=company_conversation_categories_validator)
        ...
        db.create_collection(collection_name, validator=company_conversation_categories_validator)
