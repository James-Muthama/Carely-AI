...
from company_whatsapp_config_validator import company_whatsapp_config_validator
...
collection_name = "Company_WhatsApp_Config"  # This matches the code: self.conversations_collection = self.db.CompanyConversations
...
try:
    ...
    if collection_name in db.list_collection_names():
        ...
        result = db.command("collMod", collection_name, validator=company_whatsapp_config_validator)
        ...
        db.create_collection(collection_name, validator=company_whatsapp_config_validator)
