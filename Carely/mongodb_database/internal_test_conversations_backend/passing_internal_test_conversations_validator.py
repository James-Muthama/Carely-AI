...
from internal_test_conversations_validator import internal_test_conversations_validator
...
collection_name = "Internal_Test_Conversations"  # This matches the code: self.conversations_collection = self.db.CompanyConversations
...
try:
    ...
    if collection_name in db.list_collection_names():
        ...
        result = db.command("collMod", collection_name, validator=internal_test_conversations_validator)
        ...
        db.create_collection(collection_name, validator=internal_test_conversations_validator)
