...
from company_embeddings_validator import company_embeddings_validator
...
collection_name = "Company_Embeddings"  # This matches the code: self.conversations_collection = self.db.CompanyConversations
...
try:
    ...
    if collection_name in db.list_collection_names():
        ...
        result = db.command("collMod", collection_name, validator=company_embeddings_validator)
        ...
        db.create_collection(collection_name, validator=company_embeddings_validator)
